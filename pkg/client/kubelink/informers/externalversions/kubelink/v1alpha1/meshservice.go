...
type MeshServiceInformer interface {
	...
	Lister() v1alpha1.MeshServiceLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.KubelinkV1alpha1().MeshServices(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KubelinkV1alpha1().MeshServices(namespace).Watch(context.TODO(), options)
			},
		},
		&kubelinkv1alpha1.MeshService{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *meshServiceInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&kubelinkv1alpha1.MeshService{}, f.defaultInformer)
}

func (f *meshServiceInformer) Lister() v1alpha1.MeshServiceLister {
	return v1alpha1.NewMeshServiceLister(f.Informer().GetIndexer())
}
