	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.KubelinkV1alpha1().Meshes(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KubelinkV1alpha1().Meshes(namespace).Watch(context.TODO(), options)
			},
		},
		&kubelinkv1alpha1.Mesh{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *meshInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&kubelinkv1alpha1.Mesh{}, f.defaultInformer)
}
